...
function App() {
  ...
  return (
    <div className="App">
      <div className="header" style={{ display: "flex", marginLeft: "20vw", padding: "1em",  }}>
        <Typography>
          {email}&nbsp;&nbsp;&nbsp;&nbsp;/&nbsp;&nbsp;&nbsp;&nbsp;{phoneNumber}
        </Typography>
      </div>
      ...
      <div className="Bottom-bar" style={{marginLeft: "20vw", justifyContent: "left", padding: "2vw"}}>
        <Button
        ...
        >
          <Typography>
            Download Resume &nbsp;&nbsp;&nbsp;<FontAwesomeIcon icon={faArrowDown} />
          </Typography>
        </Button>
      </div>
    </div>
